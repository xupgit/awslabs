...
This lab comprises of three primary steps: You will login into an AWS and start an EC2 F1 instance. You will then interact with the instance using PuTTy and remote desktop client, and then finally stop the running instance.
...
Account ID, IAM username, Link to access a preconfigured EC2 F1 instance
...
**2.1 Connect using PuTTY (you may skip this step for the workshop as you will be using RDP).**

**2.1.1.** Start PuTTY program

**2.1.2.** Enter _centos@&lt;public\_dns\_entry&gt;_ in the **Host Name** field and **22** in the _Port_ field
...
**2.1.4.** Click on the **Browse…** button, browse to where the private key has been stored
...
**2.1.8.** Enter exit to close the session

**2.2. Start a remote desktop session**

**2.2.1.** Start the remote desktop session

**2.2.2.** Enter the _IPv4_ address
...
**2.2.9.** You should enter the following commands in any newly opened terminal window to source the environments
