...
This lab comprises three primary steps: You will source the environment settings, then you will build and run emulation flows using Makefile, you will next test the application on the F1 instance. Appendix lists steps involved in build full system using Makefile flow including creating an Amazon FPGA Image (AFI).
...
**A.2.1.** Create a **xclbin** directory under the _Makefile\_flow_ directory using the File Explorer
